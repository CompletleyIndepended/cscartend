                    ...
                    <div class="ty-column{$columns}">
                        {if $department}
                            ...
                            <div class="ty-grid-list__item ty-quick-view-button__wrapper">
                                ...
                                <div class="ty-grid-list__item-name">
                                    <bdi>
                                        <a href="{"products.department?department_id={$department.department_id}"|fn_url}" class="product-title" title="{$department.department}">
                                            {$user_lf_name = $department.user_id|fn_get_username}
                                        </a>    
                                    </bdi>
                                </div>
                            </div>
